# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-02-22 03:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replyComment', models.DecimalField(decimal_places=0, max_digits=11, verbose_name='回复评论ID')),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='content_type_set_for_doubanmoviecomments', to='contenttypes.ContentType', verbose_name='content type')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sites.Site')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='doubanmoviecomments_comments', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
